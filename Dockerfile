...
# Ensure runtime-writable directories for non-root execution.
RUN mkdir -p /app/src/logs /tmp/matplotlib \
    && chown -R appuser:appuser /app /tmp/matplotlib

# Switch to the non-privileged user to run the application.
USER appuser

# Copy the source code into the container with non-root ownership.
